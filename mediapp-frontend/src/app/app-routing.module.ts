...
import { SignosVitalesDialogoComponent } from './pages/signosvitales/signosvitales-dialogo/signosvitales-dialogo.component';
...
const routes: Routes = [
  ...
  { path: 'signosvitales', component: SignosVitalesComponent,  children: [
    ...
    { path: 'paciente', component: SignosVitalesEdicionComponent }], canActivate: [GuardService] },
  // { path: 'signosvitales-dialogo', component: SignosVitalesDialogoComponent, canActivate: [GuardService] },
